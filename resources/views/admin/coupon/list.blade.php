...
<!-- DataTales Example -->
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h4 class="m-0 font-weight-bold text-primary float-left">Danh mục coupon</h4>
      <a href="{{route('admin.add.coupon')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Thêm danh mục</a>
    </div>
    <div class="card-body">
